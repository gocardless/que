...
require_relative "kent/adapters/base"
require_relative "kent/job"
require_relative "kent/job_timeout_error"
require_relative "kent/leaky_bucket"
require_relative "kent/locker"
require_relative "kent/migrations"
require_relative "kent/sql"
require_relative "kent/version"
require_relative "kent/worker"
require_relative "kent/worker_group"
require_relative "kent/middleware/worker_collector"
require_relative "kent/middleware/queue_collector"
    ...
    def connection=(connection)
      self.adapter =
        if connection.to_s == "ActiveRecord"
          ...
          else raise "Kent connection not recognized: #{connection.inspect}"
          end
        end
    end

    def adapter
      @adapter || raise("Kent connection not established!")
    end
...
require "kent/railtie" if defined? Rails::Railtie
